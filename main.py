...
SECTION_FILES = {
    ...
    "Construction Update": "tabs/construction_progress_update.py",
    "Construction Dashboard": "tabs/construction_progress_dashboard.py",
    "Construction Charts": "tabs/construction_progress_charts.py",
